...
EXCLUDE_PREFIX = {
    "assets","static","favicon.ico","notifications","explore","login",
    "signup","register","about","press","events","jobs","pricing","search",
    "site","enterprise","organizations","help","issues","pulls","forks",
    "gists","settings","api","opensearch","sessions","oauth","users"
}
